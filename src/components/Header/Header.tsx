                        ...
                        <div className="flex justify-start lg:w-0 lg:flex-1">
                            <a href={logoUrl}>
                                <img className="h-8 w-auto sm:h-10"
                                     src="https://uploads-ssl.webflow.com/623634729c194d6497a55433/62385b3d4f5113138af0e3b7_Intelas-Logo.svg"
                                     alt=""/>
                            </a>
                        </div>
                        <div className="-my-2 -mr-2 md:hidden">
                            <button onClick={() => setMenuOpen(!menuOpen)} type="button"
                                    className="inline-flex ring-0 items-center focus:outline-none justify-center bg-transparent p-2 text-white hover:text-secondbrand"
                                    aria-expanded="false">
